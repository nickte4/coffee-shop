export default function Card(props) {
  return (
    <>
      <div className="w-64 h-max shadow-lg bg-secondary rounded-lg cursor-pointer transition-all hover:scale-105 hover:border-2 border-primary">
        <img
          className="w-52 mx-auto mt-10 rounded-2xl"
          src={props.coverImg}
          alt="coffee bag"
        />
        <h1 className="ml-3 mt-3 px-5 text-center text-2xl mr-3">
